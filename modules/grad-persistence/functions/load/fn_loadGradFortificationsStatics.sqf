...
// --- Process Fortification Data and Spawn Objects ---
{
    ...
    [{!isNull (_this select 0)}, {
        params ["_thisGradFortificationsStatic", "_posASL", "_vectorDirAndUp", "_damage", "_isGradMoneymenuStorage", "_gradMoneymenuOwner", "_thisLbmMoney", "_gradFortificationsOwner", "_vars"];
    ...
    }, [_thisGradFortificationsStatic, _posASL, _vectorDirAndUp, _damage, _isGradMoneymenuStorage, _gradMoneymenuOwner, _thisLbmMoney, _gradFortificationsOwner, _vars]] call CBA_fnc_waitUntilAndExecute; // Pass all needed vars
