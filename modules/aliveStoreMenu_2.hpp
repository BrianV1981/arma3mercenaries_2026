...
class aliveStore_2 {
    ...
    class Nother1 {
        ...
        class B_Heli_Attack_01_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Heli_Attack_01_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Light_01_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Heli_Light_01_dynamicLoadout_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_CAS_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Plane_CAS_01_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_Fighter_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Plane_Fighter_01_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_Fighter_01_Stealth_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Plane_Fighter_01_Stealth_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_armed_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_T_VTOL_01_armed_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_mlrs_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MBT_01_mlrs_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_arty_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MBT_01_arty_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MRAP_01_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MRAP_01_hmg_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MRAP_01_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MRAP_01_gmg_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_APC_Wheeled_01_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_APC_Wheeled_01_cannon_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_APC_Tracked_01_AA_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_APC_Tracked_01_AA_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MBT_01_TUSK_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MBT_01_TUSK_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Nother2 {
        ...
        class B_MRAP_01_F {
            ...
            price = 30000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MRAP_01_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_transport_F {
            ...
            price = 40000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Truck_01_transport_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_medical_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Truck_01_medical_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_fuel_F {
            ...
            price = 60000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Truck_01_fuel_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_Repair_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Truck_01_Repair_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_ammo_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Truck_01_ammo_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MRAP_01_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MRAP_01_hmg_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MRAP_01_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MRAP_01_gmg_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Tracked_01_rcws_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_APC_Tracked_01_rcws_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Wheeled_01_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_APC_Wheeled_01_cannon_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Tracked_01_AA_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_APC_Tracked_01_AA_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_TUSK_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_MBT_01_TUSK_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Light_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Heli_Light_01_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Transport_01_F {
            ...
            price = 70000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Heli_Transport_01_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Transport_03_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_Heli_Transport_03_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_infantry_F {
            ...
            price = 10000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_T_VTOL_01_infantry_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_vehicle_F {
            ...
            price = 10000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['B_T_VTOL_01_vehicle_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Iother1 {
        ...
        class I_Heli_light_03_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Heli_light_03_dynamicLoadout_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Plane_Fighter_03_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Plane_Fighter_03_dynamicLoadout_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Plane_Fighter_04_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Plane_Fighter_04_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_MRL_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_MRL_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class I_MBT_03_cannon_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_MBT_03_cannon_F', 3600] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Iother2 {
        ...
        class I_MRAP_03_F {
            ...
            price = 30000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_MRAP_03_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_transport_F {
            ...
            price = 40000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_transport_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_medical_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_medical_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_fuel_F {
            ...
            price = 60000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_fuel_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_box_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_box_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_ammo_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Truck_02_ammo_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_MRAP_03_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_MRAP_03_hmg_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_MRAP_03_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_MRAP_03_gmg_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_APC_Wheeled_03_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_APC_Wheeled_03_cannon_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_APC_tracked_03_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_APC_tracked_03_cannon_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_TUSK_F {
        ...
        class I_Heli_light_03_unarmed_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Heli_light_03_unarmed_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Heli_Transport_02_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['I_Heli_Transport_02_F', 7200] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };	
};
