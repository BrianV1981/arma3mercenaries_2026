...
class aliveStore_2 {
    ...
    class Nother1 {
        ...
        class B_Heli_Attack_01_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS1', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Light_01_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS8', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_CAS_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS2', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_Fighter_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS3', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Plane_Fighter_01_Stealth_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS4', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_armed_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS15', 3600, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_mlrs_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['ARTY2', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_arty_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['ARTY1', 3600, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MRAP_01_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS11', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MRAP_01_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS12', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_APC_Wheeled_01_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS9', 3600, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_APC_Tracked_01_AA_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS13', 3600, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_MBT_01_TUSK_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS10', 3600, player, 200000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Nother2 {
        ...
        class B_MRAP_01_F {
            ...
            price = 30000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT15', 7200, player, 30000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_transport_F {
            ...
            price = 40000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT6', 7200, player, 40000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_medical_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT14', 7200, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_fuel_F {
            ...
            price = 60000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT11', 7200, player, 60000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_Repair_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT12', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Truck_01_ammo_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT13', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MRAP_01_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT16', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MRAP_01_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT17', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Tracked_01_rcws_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT8', 7200, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Wheeled_01_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT9', 7200, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_APC_Tracked_01_AA_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT18', 7200, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_TUSK_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT10', 7200, player, 200000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Light_01_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT3', 7200, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Transport_01_F {
            ...
            price = 70000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT1', 7200, player, 70000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_Heli_Transport_03_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT2', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_infantry_F {
            ...
            price = 10000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT29', 7200, player, 10000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class B_T_VTOL_01_vehicle_F {
            ...
            price = 10000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT30', 7200, player, 10000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Iother1 {
        ...
        class I_Heli_light_03_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS5', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Plane_Fighter_03_dynamicLoadout_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS6', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Plane_Fighter_04_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS7', 3600, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_MRL_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['ARTY3', 3600, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
		class I_MBT_03_cannon_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['CAS14', 3600, player, 200000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };
    ...
    class Iother2 {
        ...
        class I_MRAP_03_F {
            ...
            price = 30000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT24', 7200, player, 30000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_transport_F {
            ...
            price = 40000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT7', 7200, player, 40000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_medical_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT23', 7200, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_fuel_F {
            ...
            price = 60000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT22', 7200, player, 60000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_box_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT21', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Truck_02_ammo_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT20', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_MRAP_03_hmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT25', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_MRAP_03_gmg_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT26', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_APC_Wheeled_03_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT27', 7200, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_APC_tracked_03_cannon_F {
            ...
            price = 150000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT28', 7200, player, 150000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class B_MBT_01_TUSK_F {
            ...
            price = 200000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT19', 7200, player, 200000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Heli_light_03_unarmed_F {
            ...
            price = 50000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT4', 7200, player, 50000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
        class I_Heli_Transport_02_F {
            ...
            price = 100000;
            stock = 100;
            code = "if (player == (_this select 0)) then { ['TRANSPORT5', 7200, player, 100000] remoteExecCall ['A3M_fnc_requestCombatSupport', 2] };";
        };
    };	
};
