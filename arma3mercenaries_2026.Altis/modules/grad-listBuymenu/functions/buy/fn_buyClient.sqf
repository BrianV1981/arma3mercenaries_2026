...
// A3M Logistics Overhaul: Always open Destination Selector for physical items
if (_kindOf in ["WEAPONS", "ITEMS", "WEARABLES", "FORTIFICATION"]) exitWith {
...
// If it's a vehicle or unit, proceed normally
