    ...
    class mercenaryStore_1 {
		...
		class units_1 {
			...
			class B_CTRG_Soldier_TL_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_TL_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_Exp_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_Exp_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_Medic_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_Medic_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_M_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_M_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_LAT_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_LAT_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_AR_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_AR_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_CTRG_Soldier_JTAC_tna_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_CTRG_Soldier_JTAC_tna_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	};
		//category:  
        class units_2 {
			...
			class I_G_Soldier_unarmed_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_unarmed_F", _this select 0] spawn A3M_fnc_initMercenary;
            };		
			class I_G_Soldier_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_lite_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_lite_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_SL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_SL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_A_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_A_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_officer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_officer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Sharpshooter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Sharpshooter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_G_Soldier_LAT2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_G_Soldier_LAT2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };	
	};
		 //category:  
        class units_3 {
			...
			class B_GEN_Commander_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_GEN_Commander_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_GEN_Soldier_universal_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_GEN_Soldier_universal_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	};		
		 //category:  
        class units_4 {
			...
			class B_Soldier_unarmed_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_unarmed_F", _this select 0] spawn A3M_fnc_initMercenary;
            };		
			class B_officer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_officer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Soldier_SL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_SL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Patrol_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Patrol_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Soldier_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Soldier_lite_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_lite_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_soldier_AAR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AAR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Soldier_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Patrol_Soldier_MG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Patrol_Soldier_MG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_HeavyGunner_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_HeavyGunner_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Patrol_Soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Patrol_Soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Sharpshooter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Sharpshooter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_sniper_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_sniper_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_spotter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_spotter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_soldier_PG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_PG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Soldier_A_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Soldier_A_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_soldier_AT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_soldier_AA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_soldier_AAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_soldier_AAA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_AAA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_soldier_mine_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_mine_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_soldier_repair_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_soldier_repair_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Patrol_Engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Patrol_Engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };		
			class B_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_diver_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_diver_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_diver_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_diver_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_diver_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_diver_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_support_Mort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_support_Mort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_support_AMort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_support_AMort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_support_MG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_support_MG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_support_GMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_support_GMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_support_AMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_support_AMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Patrol_Soldier_UAV_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Patrol_Soldier_UAV_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Fighter_Pilot_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Fighter_Pilot_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_Pilot_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Pilot_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_helicrew_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_helicrew_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_crew_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_crew_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_recon_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_recon_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_Recon_Sharpshooter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_Recon_Sharpshooter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_recon_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_recon_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_recon_JTAC_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_JTAC_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_T_Recon_M_F {
                displayName = "NATO Recon Marksman";
                description = "This is a NATO Recon Marksman.";
                ...
                amount = 1;
                stock = 9999;
				code = ["B_T_Recon_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class B_recon_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
			class B_recon_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["B_recon_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	};
        //category: 
		class units_5 {
			...
			class I_C_Soldier_Para_1_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_1_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_3_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_3_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_4_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_4_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_5_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_5_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_6_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_6_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_7_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_7_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Para_8_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Para_8_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_1_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_1_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_4_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_4_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_7_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_7_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_8_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_8_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_C_Soldier_Bandit_3_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_C_Soldier_Bandit_3_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	};						
		//category:  
        class units_6 {
			...
			class I_soldier_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_soldier_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_lite_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_lite_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_A_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_A_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_SL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_SL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_repair_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_repair_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_crew_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_crew_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_helipilot_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_helipilot_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_pilot_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_pilot_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_helicrew_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_helicrew_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_officer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_officer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_soldier_UAV_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_soldier_UAV_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_universal_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_universal_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_diver_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_diver_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_diver_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_diver_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_diver_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_diver_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Spotter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Spotter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Sniper_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Sniper_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AAR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AAR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_AAA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_AAA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_support_MG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_support_MG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_support_GMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_support_GMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_support_Mort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_support_Mort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_support_AMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_support_AMG_F7", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_support_AMort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_support_AMort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_soldier_UAV_06_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_soldier_UAV_06_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_soldier_UAV_06_medical_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_soldier_UAV_06_medical_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_soldier_mine_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_soldier_mine_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_Soldier_LAT2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_Soldier_LAT2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	  };		
		//category:  
        class units_7 {
			...
			class I_E_Soldier_unarmed_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_unarmed_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_A_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_A_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AAR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AAR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_lite_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_lite_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Officer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Officer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_SL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_SL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_RadioOperator_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_RadioOperator_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_LAT2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_LAT2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AAA_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AAA_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_AAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_AAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Support_GMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Support_GMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Support_MG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Support_MG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Support_Mort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Support_Mort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Support_AMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Support_AMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Support_AMort_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Support_AMort_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_Pathfinder_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_Pathfinder_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_Exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_Exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_Repair_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_Repair_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_CBRN_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_CBRN_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_MP_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_MP_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_Soldier_UAV_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_Soldier_UAV_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_soldier_UAV_06_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_soldier_UAV_06_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_soldier_UAV_06_medical_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_soldier_UAV_06_medical_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_soldier_UGV_02_Science_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_soldier_UGV_02_Science_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_E_soldier_UGV_02_Demining_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_E_soldier_UGV_02_Demining_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
	};
		//category:  
        class units_8 {
			...
			class O_R_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Soldier_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Soldier_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_soldier_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_soldier_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_JTAC_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_JTAC_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_exp_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_exp_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_medic_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_medic_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_GL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_GL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_recon_JTAC_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_recon_JTAC_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_TL_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_TL_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_AR_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_AR_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_AR2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_AR2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_A_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_A_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_M_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_M_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_M2_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_M2_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_Medic {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_Medic", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_Engineer_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_Engineer_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_R_Patrol_Soldier_LAT_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_R_Patrol_Soldier_LAT_F", _this select 0] spawn A3M_fnc_initMercenary;
            };			
		};
		//category:  
        class units_9 {
			...
			class O_V_Soldier_TL_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_TL_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_Exp_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_Exp_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_Medic_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_Medic_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_M_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_M_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_LAT_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_LAT_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class O_V_Soldier_JTAC_hex_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["O_V_Soldier_JTAC_hex_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
		};
		//category:  
        class units_10 {
			...
			class I_L_Looter_Pistol_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Looter_Pistol_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_L_Looter_SG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Looter_SG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_L_Looter_SMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Looter_SMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_L_Criminal_SG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Criminal_SG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_L_Criminal_SMG_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Criminal_SMG_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
			class I_L_Hunter_F {
                ...
                amount = 1;
                stock = 9999;
				code = ["I_L_Hunter_F", _this select 0] spawn A3M_fnc_initMercenary;
            };
