...
// --- A3M ANTI-SPAM PACER ---
private _lastTransfer = player getVariable ["A3M_Fort_LastTransferTime", 0];
if (diag_tickTime - _lastTransfer < 0.5) exitWith { 
    systemChat "Transfer processing. Please wait..."; 
};
player setVariable ["A3M_Fort_LastTransferTime", diag_tickTime];
// ---------------------------
