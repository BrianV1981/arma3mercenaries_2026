class CfgHints {
    class A3M_FieldManual {
        displayName = "A3M Field Manual";
        logicalOrder = 1;
        class A3MCustomSquadControls {
            displayName = "A3M Custom Squad Controls";
            description = "<t color='#ffaa00'>ACE INTERACTION MENU</t><br/>
...
Resets your AI group's formation and combat states. Extremely useful after recovering from incapacitation when the AI might try to assume leadership, or if they are acting buggy.";
        ...
        class The4InventorySystems {
            displayName = "The 4 Inventory Systems";
            description = "<t color='#ffaa00'>1. PLAYER INVENTORY</t><br/>
...
A specialized virtual inventory specifically for holding unbuilt construction materials (walls, bunkers, tank traps). It has massive space limits and can be accessed on players or vehicles.";
        ...
        class LogisticsSurvivalandMedical {
            displayName = "Logistics, Survival, and Medical";
            description = "<t color='#ffaa00'>REARMING</t><br/>
...
You MUST carry <t color='#ffff00'>Zip Ties</t> for detaining civilians (Interrogations) and forcing AI onto static turrets! Also carry basic ACE Medical gear.";
        ...
        class RanksandProgression {
            displayName = "Ranks and Progression";
            description = "<t color='#ffaa00'>RANKS AND REWARDS</t><br/>
...
• PRIVATE (Start) | CORPORAL (1k) | SERGEANT (1.5k) | LIEUTENANT (2k) | CAPTAIN (2.5k) | MAJOR (3k) | COLONEL (3.5k Max)";
        ...
        class TheDynamicALiVEWar {
            displayName = "The Dynamic ALiVE War";
            description = "<t color='#ffaa00'>A LIVING, BREATHING BATTLEFIELD</t><br/>
...
The frontlines naturally shift as NATO and OPFOR clash. All Sector Control scripts and military objectives are entirely handled by ALiVE, creating a highly unpredictable and replayable warzone. You are just a contractor caught in the middle.";
        ...
        class CombatSupportALiVE {
            displayName = "Combat Support (ALiVE)";
            description = "<t color='#ffaa00'>THE ALiVE NETWORK</t><br/>
...
• <t color='#ffffff'>ARTILLERY:</t> Rain fire on enemy compounds with pinpoint accuracy using high-explosive, illumination, or cluster munitions.";
        ...
        class LogisticsandBaseBuilding {
            displayName = "Logistics and Base Building";
            description = "<t color='#ffaa00'>THE FOUR INVENTORIES</t><br/>
...
Any fortifications you build and place in the world are strictly persistent. They will survive server restarts. Build a base and stockpile your armory!";
        ...
        class AIMercenariesandBarracks {
            displayName = "AI Mercenaries and Barracks";
            description = "<t color='#ffaa00'>PURCHASING RECRUITS</t><br/>
...
When the server restarts, any AI squad members that were actively deployed with you will spawn back in safely handcuffed and set to captive. This is a fail-safe to prevent them from dying while the server loads. Simply approach them and use your ACE Interaction menu to 'Mobilize' them and return them to combat readiness!";
        ...
        class VehicleOperationsandGarage {
            displayName = "Vehicle Operations and Garage";
            description = "<t color='#ffaa00'>CLAIMING AND LOCKING</t><br/>
...
Any player-owned vehicle left out on the battlefield is persistent! When the server restarts, your claimed vehicles and static weapons will load exactly where you left them.";
        ...
        class DronesandAerialPayloads {
            displayName = "Drones and Aerial Payloads";
            description = "<t color='#ffaa00'>ATTACHING EXPLOSIVES</t><br/>
...
Alternatively, once a payload is attached, pilots can select <t color='#ff8c00'>[ARM KAMIKAZE MODE]</t> from their scroll wheel. This locks the payload to the drone. The exact millisecond the drone crashes into a target, hits a wall, or is shot out of the sky, the massive payload will detonate instantly. An emergency <t color='#ffa500'>[DETONATE KAMIKAZE]</t> action is also provided for manual mid-airbursts.";
        ...
        class AsymmetricThreatsandFactions {
            displayName = "Asymmetric Threats and Factions";
            description = "<t color='#ffaa00'>THE INSURGENCY</t><br/>
...
• <t color='#ffffff'>Suicide Bombers:</t> Hostile locals who will rush your position and detonate. Shoot to kill if a civilian charges you!";
        ...
        class DeathandPersistence {
            displayName = "Death and Persistence";
            description = "<t color='#ffaa00'>ABSOLUTE PERSISTENCE</t><br/>
...
When you die, a red marker appears on the map. Your corpse and gear will remain in the world for exactly 2 HOURS. If you do not recover your items before the timer expires, they are lost permanently.";
        ...
        class TheEconomyandAlternativeIncome {
            displayName = "The Economy and Alternative Income";
            description = "<t color='#ffaa00'>BANK VS. WALLET</t><br/>
...
Watch your fire! Friendly Fire incidents will instantly dock your bank account and transfer those funds directly to the victim as compensation.";
        ...
        class AdvancedOperationsHVTs {
            displayName = "Advanced Operations (HVTs)";
            description = "<t color='#ffaa00'>INTERROGATIONS</t><br/>
...
Got a grudge? Place a financial bounty on another player's head using the Player Dossier (Press 'P'). Whoever kills them claims the cash instantly.";
        ...
        class TheCoreGameplayLoop {
            displayName = "The Core Gameplay Loop";
            description = "<t color='#ffaa00'>1. INTERROGATE FOR SEED MONEY</t><br/>
...
Resets your AI group's formation and combat states. Extremely useful after recovering from incapacitation when the AI might try to assume leadership, or if they are acting buggy.";
        ...
        class Welcome {
            displayName = "Welcome";
            description = "<t color='#ff0000'>BETA DISCLAIMER</t><br/>This server is currently in BETA. It has bugs—some fixable, some unfixable (for which we try to come up with workarounds).<br/>Please note that we have a built-in <t color='#00ff00'>Bug Report Tool</t> on the Escape/Pause menu. Use it to report bugs, submit suggestions, or report players.<br/><br/><t color='#ff0000'>BETA DISCLAIMER</t><br/>This server is currently in BETA. It has bugs—some fixable, some unfixable (for which we try to come up with workarounds).<br/>Please note that we have a built-in <t color='#00ff00'>Bug Report Tool</t> on the Escape/Pause menu. Use it to report bugs, submit suggestions, or report players.<br/><br/>Welcome to <t color='#ffaa00'>Arma 3 Mercenaries (A3M)</t>!<br/><br/>
...
You can also press the <t color='#00aaff'>'P'</t> key at any time to open your Player Dossier for live stats, leaderboards, and quick guides.";
        };
        class A3MNarrative {
            displayName = "A3M: Narrative";
            description = "<t size='18' color='#FFA500'>A3M: The Shadow War (Narrative Briefing)</t><br/><br/>
<t face='PuristaBold'>DATE:</t> October 14, 2026<br/>
<t face='PuristaBold'>LOCATION:</t> Altis, Mediterranean Sea<br/>
<t face='PuristaBold'>CLASSIFICATION:</t> TOP SECRET // NOFORN // EYES ONLY<br/><br/>

<t size='16' color='#FFA500'>The Geopolitical Flashpoint</t><br/>
...
Under the Trump administration, NATO forces—headquartered at the Molos Airfield in the northeast—are unwilling to trigger an overt World War III by launching a full-scale conventional invasion. Instead, the CIA has authorized <t face='PuristaBold'>Operation Black Shield</t>.<br/><br/>

They aren't sending in the Marines. They're sending in the blank checks.<br/><br/>

<t size='16' color='#FFA500'>The Constellis Mandate</t><br/>
You are an elite, highly autonomous operator flying under the banner of <t face='PuristaBold'>Constellis</t> (formerly Blackwater/Academi). Your presence on Altis is completely deniable. If you are captured, the U.S. Government will disavow any knowledge of your actions.<br/><br/>
...
<t size='16' color='#FFA500'>The Technology Edge &amp; Hardware</t><br/>
...
To expand Constellis' operational reach, PMCs are regularly contracted to conduct high-risk <t face='PuristaBold'>Network Infiltration Missions</t>. These missions require operators to assault heavily defended CSAT radio towers and antennas scattered across the AO. Once the perimeter is secured, operators must physically install and hardwire Palantir AIP server blades into the enemy's own infrastructure, hijacking their sensor data and feeding it directly back into the Constellis intelligence grid.<br/><br/>

<t size='16' color='#FFA500'>The Ground Reality &amp; Banking</t><br/>
Survival requires brutal pragmatism. You'll build massive Forward Operating Bases (FOBs) like <t face='PuristaBold'>Fort MAGA</t> using HESCO barriers and heavy turrets hauled in via ACE Cargo networks. You must manage your own hydration, medical supplies, and vehicle maintenance.<br/><br/>
...
<t face='PuristaLight'>Note: The underground financial systems that facilitate PMC payouts, bounties, and offshore accounts are currently being restructured. A massive banking overhaul is impending, which will fully integrate real-world financial institutions and corporate brands into the A3M economy, allowing PMCs to launder and secure their combat earnings with unprecedented realism.</t><br/><br/>

<t size='16' color='#FFA500'>The Shadow War (PvP Directive)</t><br/>
The true danger, however, isn't just AI.<br/><br/>

The battlefield on Altis is fully asymmetric. <t face='PuristaBold'>The Red Faction (CSAT and FIA) is playable.</t> While you operate as a high-tech PMC, other players will drop in directly as OPFOR commanders and insurgents to actively hunt you down. They will use the terrain against you, setting up player-controlled ambushes, rigging VBIEDs, and coordinating the massive CSAT AI war machine to crush your operations.<br/><br/>
