        ...
        if(!alive _x) then
            {
                    ...
                    // Issue Ticket: #01 - fn_cleanup.sqf Server Crash Loop
                    // Added safety check to prevent crash on unclaimed/wild vehicles where HG_Owner is nil.
