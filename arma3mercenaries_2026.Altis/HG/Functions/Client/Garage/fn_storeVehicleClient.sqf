...
private["_allowedTypes","_pos","_near"];
_allowedTypes = getArray(getMissionConfig "CfgClient" >> "HG_GaragesCfg" >> _garage >> "allowedTypes");

// A3M Markerless Overhaul: We completely ignore hardcoded marker configurations.
// Instead, we dynamically scan a 100m radius around the player (who is standing at the laptop).
_pos = player;
