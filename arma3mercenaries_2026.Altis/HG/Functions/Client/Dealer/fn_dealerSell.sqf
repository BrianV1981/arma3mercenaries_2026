...
// Issue Ticket: #02 - ALiVE Persistent Vehicle Duplication Bug
// Destroy ALiVE profile before deleting the physical vehicle so it doesn't respawn on restart.
private _profileID = _vehicle getVariable ["profileID", ""];
if (_profileID != "") then {
