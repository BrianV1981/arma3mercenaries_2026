...
// Save the laptop object globally so fn_buyVehicle knows where to spawn the vehicle relative to it.
params["_whatShop", ["_target", objNull]];
A3M_HG_CurrentLaptop = _target;
...
[] spawn {
    ...
    [(findDisplay 6000), "vehicles"] call A3M_fnc_drawNav;
};
