...
class HG_DefaultShop 
{
    ...
    class Svehicles
    {
        ...
        vehicles[] =
        {
            ...
            {"I_Truck_02_medical_F", 25000, "true", "This KamAZ Medical can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"I_Truck_02_fuel_F", 30000, "true", "This KamAZ Fuel can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"I_Truck_02_box_F", 50000, "true", "This KamAZ Repair can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"I_Truck_02_ammo_F", 50000, "true", "This KamAZ Ammo can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Truck_01_transport_F", 20000, "true", "This HEMTT Transport can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Truck_01_medical_F", 25000, "true", "This HEMTT Medical can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_Truck_01_fuel_F", 30000, "true", "This HEMTT Fuel can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_Truck_01_Repair_F", 50000, "true", "This HEMTT Repair can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_Truck_01_ammo_F", 50000, "true", "This HEMTT Ammo can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
    ...
    class LAvehicles
    {
        ...
        vehicles[] =
        {
            ...
            {"B_APC_Wheeled_01_cannon_F", 75000, "true", "This Badger IFV transport can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_AFV_Wheeled_01_up_cannon_F", 475000, "true", "No description available in the Quartermaster network."},
            {"B_APC_Tracked_01_rcws_F", 75000, "true", "This Namer Transport can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"I_APC_tracked_03_cannon_F", 75000, "true", "This FV510 Warrior Transport can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_APC_Tracked_01_AA_F", 75000, "true", "This Bardelas (AA) can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
        };
        spawnPoints[] =
        {
            {"Main Spawn",{"civilian_vehicles_spawn_1"}}
    ...
    class HAvehicles
    {
        ...
        vehicles[] =
        {
            {"I_MBT_03_cannon_F", 100000, "true", "This Leopard 2SG C combat support artillery can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_MBT_01_TUSK_F", 100000, "true", "This Leopard 2SG can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"O_MBT_04_command_F", 675000, "true", "No description available in the Quartermaster network."}
        };
        spawnPoints[] =
        {
            {"Main Spawn",{"civilian_vehicles_spawn_1"}}
    ...
    class Avehicles
    {
        ...
        vehicles[] =
        {
            {"B_T_VTOL_01_infantry_F", 50000, "true", "This V-44 X Blackfish Infantry transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_T_VTOL_01_armed_F", 75000, "true", "This V-44 X Blackfish combat support vehicle can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"I_Plane_Fighter_04_F", 25000, "true", "This JAS 39 Gripen combat support jet can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"I_Plane_Fighter_03_dynamicLoadout_F", 25000, "true", "This L-159 ALCA combat support jet can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Plane_Fighter_01_F", 25000, "true", "This F/A-181 Black Wasp II combat support jet can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Plane_Fighter_01_Stealth_F", 50000, "true", "This F/A-181 Black Wasp II (Stealth) combat support jet can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."}
        };
        spawnPoints[] =
        {
            {"Main Spawn",{"civilian_vehicles_spawn_1"}}
    ...
    class Hvehicles
    {
        ...
        vehicles[] =
        {
            ...
            {"B_Heli_Light_01_F", 25000, "true", "Purchasing this will give you 120 minutes of access to a MH-9 Hummingbird transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"B_Heli_Light_01_dynamicLoadout_F", 25000, "true", "Purchasing this will give you 60 minutes of access to a AH-6 Little Bird combat support helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"I_Heli_light_03_unarmed_F", 25000, "true", "Purchasing this will give you 120 minutes of access to a AW159 Wildcat (Unarmed) transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"I_Heli_light_03_dynamicLoadout_F", 25000, "true", "Purchasing this will give you 60 minutes of access to a AW159 Wildcat (CAS) combat support helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Heli_Transport_01_F", 35000, "true", "Purchasing this will give you 120 minutes of access to a UH-80 Ghost Hawk transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            {"I_Heli_Transport_02_F", 50000, "true", "Purchasing this will give you 120 minutes of access to a W101 Merlin transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
            ...
            {"B_Heli_Transport_03_F", 50000, "true", "Purchasing this will give you 120 minutes of access to a CH-67 Huron transport helicoptor, that can be utilized from your Ace Self Interact Menu > ALiVE > ALiVE Combat Support."},
