/*
    ...
    by BrianV1981
    Version: Updated Penalty Warning Setting Label
*/
    ...
    class CBA {
        class arma3mercenaries {
            ...
            class killFeedSettings {
                ...
                // <<< UPDATED SETTING >>>
                class penaltyWarningsEnabled { // Renamed from silentHints
                    title = "Enable Penalty/Warning Messages"; // Updated Title
                    description = "Toggles the dynamic text display for penalties (FF, Civ, Indep), compensation (FF), and death."; // Updated Description
                    typeName = "BOOL";
                    value = 1; // Default: Enabled
                };
				class penaltyWarningDuration {
                    title = "Penalty/Warning Display Duration";
                    description = "Adjust the duration (in seconds) the penalty/warning message remains on screen.";
                    typeName = "NUMBER";
                    value = 6; // Default value (was hardcoded before)
                    values[] = {1, 20}; // Min: 1 second, Max: 20 seconds
                };
                // <<< END OF UPDATE >>>
            };
            ...
            class markerSettings {
                ...
                class globalKillMarker {
                    ...
                    typeName = "BOOL";
                    value = 1; // Default value: 1 (enabled) - Changed default to true based on your SQF
                };
                ...
                // <<< REMOVED Unconscious Marker Setting >>>
            };
        };
    };
};