...
[_cargoClass, _buyer, _side, _vtolClass, _pilotClass, _crewClass, _fortsArray, _magsArray, _itemsArray] spawn { 
    ...
    [_group, _cargoClass, _buyer, _fortsArray, _magsArray, _itemsArray] spawn {
        ...
        private _a3mMsg = "<t align='left'><t font='RobotoCondensedBold' size='0.8' color='#FF8C00'>SUPPLY DROP DELIVERED</t><br/><t font='RobotoCondensed' size='0.6' color='#FFFFFF'>Please remember to check BOTH the supply drop container inventories, the standard<br/>inventory and the container's Fortification inventory (via ACE Interaction) to access all delivered items!</t></t>";
