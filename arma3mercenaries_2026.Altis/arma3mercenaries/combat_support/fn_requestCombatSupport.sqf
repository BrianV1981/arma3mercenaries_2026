...
if (isNil "A3M_CombatSupportConfig") then {
    A3M_CombatSupportConfig = createHashMapFromArray [
        ...
        ["CAS2", ["B_Plane_CAS_01_F", "WEST", "CAS", "A-164 Wipeout", "blufor_cas_2", 60]],
        ["CAS3", ["B_Plane_Fighter_01_F", "WEST", "CAS", "F/A-181 Black Wasp II", "blufor_cas_3", 60]],
        ["CAS4", ["B_Plane_Fighter_01_Stealth_F", "WEST", "CAS", "F/A-181 Black Wasp II (Stealth)", "blufor_cas_4", 60]],
