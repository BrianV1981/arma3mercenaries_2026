...
if (isNil "A3M_CombatSupportConfig") then {
    A3M_CombatSupportConfig = createHashMapFromArray [
        ...
        ["CAS15", ["B_T_VTOL_01_armed_F", "WEST", "CAS", "V-44 X Blackfish C", "blufor_cas_12", 60]],
        ["CAS2", ["B_Plane_CAS_01_F", "WEST", "CAS", "A-164 Wipeout", "blufor_cas_2", 225]],
        ["CAS3", ["B_Plane_Fighter_01_F", "WEST", "CAS", "F/A-181 Black Wasp II", "blufor_cas_3", 225]],
        ["CAS4", ["B_Plane_Fighter_01_Stealth_F", "WEST", "CAS", "F/A-181 Black Wasp II (Stealth)", "blufor_cas_4", 225]],
        ["CAS5", ["I_Heli_light_03_dynamicLoadout_F", "GUER", "CAS", "AW159 Wildcat (CAS)", "independent_cas_1", 60]],
        ["CAS6", ["I_Plane_Fighter_03_dynamicLoadout_F", "GUER", "CAS", "L-159 ALCA", "independent_cas_2", 60]],
        ["CAS7", ["I_Plane_Fighter_04_F", "GUER", "CAS", "JAS 39 Gripen", "independent_cas_3", 60]],
        ["CAS8", ["B_Heli_Light_01_dynamicLoadout_F", "WEST", "CAS", "AH-6 Little Bird", "blufor_cas_5", 60]],
        ["CAS9", ["B_APC_Wheeled_01_cannon_F", "WEST", "CAS", "Badger IFV C", "blufor_cas_7", 60]],
        ...
        ["TRANSPORT16", ["B_MRAP_01_hmg_F", "WEST", "TRANSPORT", "M-ATV (HMG)", "blufor_transport_13", 60]],
        ...
        ["TRANSPORT2", ["B_Heli_Transport_03_unarmed_F", "WEST", "TRANSPORT", "CH47I Chinook", "blufor_transport_2", 60]],
        ...
        ["TRANSPORT3", ["B_Heli_Light_01_F", "WEST", "TRANSPORT", "MH-9 Hummingbird", "blufor_transport_3", 60]],
        ["TRANSPORT30", ["B_T_VTOL_01_vehicle_F", "WEST", "TRANSPORT", "V-44 X Blackfish V", "blufor_transport_17", 225]],
        ["TRANSPORT4", ["I_Heli_light_03_unarmed_F", "GUER", "TRANSPORT", "AW159 Wildcat (Unarmed)", "independent_transport_1", 60]],
        ["TRANSPORT5", ["I_Heli_Transport_02_F", "GUER", "TRANSPORT", "AW101 Merlin", "independent_transport_2", 60]],
