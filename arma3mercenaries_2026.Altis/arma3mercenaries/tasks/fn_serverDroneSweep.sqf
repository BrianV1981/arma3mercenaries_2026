...
// Create Greyhawk UAV High Above Target
private _spawnPos = [_exactPos select 0, _exactPos select 1, 600];
private _vehArray = [_spawnPos, random 360, "B_UAV_02_dynamicLoadout_F", civilian] call BIS_fnc_spawnVehicle;
